...
are used by domain services (QueryPlanner, SemanticValidator) to
process queries without depending on application-layer DTOs.
"""
...
class QuerySpec:
    ...
    This is the domain-layer representation of a semantic query that
