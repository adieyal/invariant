"""Query plan value objects for the Query component.

This module contains the internal query planning data structures.
These are NOT exported in the public Query API.
"""
