...
class TestEntityIdentity:
    ...
    def test_study_is_same_class(self):
        ...
        from invariant.catalog.domain.entities.study import Study as DomainStudy
    ...
    def test_dataset_is_same_class(self):
        ...
        from invariant.catalog.domain.entities.dataset import Dataset as DomainDataset
    ...
    def test_data_product_is_same_class(self):
        ...
        from invariant.catalog.domain.entities.data_product import (
            DataProduct as DomainDataProduct,
        )
    ...
    def test_variable_is_same_class(self):
        ...
        from invariant.catalog.domain.entities.variable import (
            Variable as DomainVariable,
        )
